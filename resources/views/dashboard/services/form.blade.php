@php
    $title = $resource->id ? __('Edit') . ' ' . __('Service') : __('Add') . ' ' . __('Service');
@endphp
            ...
            <form class="form" action="{{ $resource->id ? route('admin.service.update', $resource->id) : route('admin.service.store') }}"
                ...
                <div class="row">
                    <div class="col-12   ">
                        ...
                        {!! Form::label('image', __('Image') , ['class' => 'form-label'] ) !!} (<small class="text-danger">{{ __('best_size') }} : w:950 * h:500</small>)<br>
