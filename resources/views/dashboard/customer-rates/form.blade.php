...
<div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content ">
      ...
      <div class="modal-body">
        <form id="counter-form"  class="form" action="{{ $resource->id ? route('admin.rate.update', $resource->id) : route('admin.rate.store') }}"
            ...
            <div class="row">
                ...
                <div class="col-12  ">
                    ...
                    {!! Form::label('Rate', __('Rate') , ['class' => 'form-label'] ) !!} <br>

                    <input type="number" name="rate" max="5" min="1" value="{{ $resource->rate }}" class="form-control" step"1" required>
                    {{--  {!! Form::number("rate", old("rate", $resource->rate), ['class' => 'form-control','max'=>'5']) !!}  --}}
            ...
            @endforeach
                ...
                <div class="col-md-6 pt-2">
                    <div class="form-group">
                        ...
                        {!! Form::textarea("{$locale}[comment]", old("{$locale}[comment]", optional($resource->translate($locale))->comment), ['class' => 'form-control']) !!}
                    </div>
                </div>
            @endforeach
