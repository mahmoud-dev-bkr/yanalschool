...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content ">
      ...
      <div class="modal-body">
        <form class="form" action="{{ $resource->id ? route('admin.social.update', $resource->id) : route('admin.social.store') }}"
            method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12  ">

                    {!! Form::label('icon', __('icon') , ['class' => 'form-label'] ) !!} (<small class="text-danger">{{ __('best_size') }} : w:210 * h:210 , يجب أن تكون الصورة بيضاء</small> ) <br>
                    <img class=" image-preview-icon m-auto rounded-circle" width="80" height="80"   src="{{ asset($resource->icon ?? 'assets/img/default.jpg' ) }}">
                    <br>
               ...
               <div class="col-md-12">
                   <div class="form-group">
                       ...
                       <input type="url" name="url" id="url" class="form-control" value="{{ $resource->url }}">
                   </div>
               </div>
