...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content ">
      ...
      <div class="modal-body">
        <form class="form" action="{{ $resource->id ? route('admin.info.update', $resource->id) : route('admin.info.store') }}"
            method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12  ">

                    {!! Form::label('image', __('image') , ['class' => 'form-label'] ) !!} (<small class="text-danger">{{ __('best_size') }} : w:210 * h:210 , يجب أن تكون الصورة بيضاء</small> ) <br>
