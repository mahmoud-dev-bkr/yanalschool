        ...
        <form class="form" action="{{ $resource->id ? route('admin.feature.update', $resource->id) : route('admin.feature.store') }}"
            ...
            <div class="row">
                <div class="col-12 text-center ">
                    ...
                    {!! Form::label('image', __('image') , ['class' => 'form-label'] ) !!} (<small class="text-danger">{{ __('best_size') }} : w:88 * h:88 , يجب أن تكون الصورة بيضاء</small> ) <br>
                    <img class=" image-preview-image bg-dark rounded-circle" width="100" height="100"   src="{{ asset($resource->image ?? 'assets/img/default.jpg' ) }}">
                    <br>
