...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content ">
      ...
      <div class="modal-body">
        <form id="counter-form"  class="form" action="{{ $resource->id ? route('admin.value.update', $resource->id) : route('admin.value.store') }}"
            method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12  ">

                    {!! Form::label('image', __('Icon') , ['class' => 'form-label'] ) !!} <br>
                    <img class="bg-dark p-2 image-preview-image m-auto rounded-circle" width="60" height="60"   src="{{ asset($resource->icon ?? 'assets/img/default.jpg' ) }}">
                    <br>
                    ...
                    <input type="file"  onchange="changeImage(this, 'image')" id="image" class="d-none form-control mt-3" name="icon" >
                </div>
